...
# Series 인스턴스 생성
sr1 = pd.Series(data1, index=['a', 'b', 'c', 'd', 'e'], dtype='int8', name = 'data')
sr2 = pd.Series(data1)
...
print(f"name   : {sr1.name}")       # 부가/메타 정보로 이름
...
print(f"ndim   : {sr2.ndim}")       # 차원(1, 2, ... , N) 정보
print(f"dtype  : {sr2.dtype}")      # 원소의 데이터 타입 정보
print(f"name   : {sr2.name}")       # 부가/메타 정보로 이름
