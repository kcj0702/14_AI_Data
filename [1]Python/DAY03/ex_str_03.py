...
# => 'L'의 인덱스 출력
idx = msg.find("L")
print(f"'L'의 인덱스 : {idx}번")

# => ' Lu'의 인덱스 출력
idx = msg.find(" Lu")
print(f"' Lu'의 인덱스 : {idx}번")
...
# -------------------------
# [3] 원소/요소 검사 관련 메서드 : isXXXX()
#       * 결과 : True/False
#       * 알파벳만으로 된 str 인지 : isalpha()
#       * 숫자만으로 된 str 인지 : isdecimal() 0~9
#       * 숫자, 알파벳으로만 된 str 인지 : isalnum()
# -------------------------
msg = "Happy"
phone = "01011112222"
userid = "k1234"
